...
SYSTEMS = [BUNDLESDF_CUBE_SYSTEM, CUBE_SYSTEM, ELBOW_SYSTEM, ASYMMETRIC_SYSTEM, BUNDLESDF_BOTTLE_SYSTEM, BUNDLESDF_NAPKIN_SYSTEM, BUNDLESDF_PRISM_SYSTEM]
...
REAL_DATA_ASSETS = {CUBE_SYSTEM: CUBE_DATA_ASSET, ELBOW_SYSTEM: ELBOW_DATA_ASSET, BUNDLESDF_CUBE_SYSTEM: BUNDLESDF_CUBE_DATA_ASSET, BUNDLESDF_BOTTLE_SYSTEM: BUNDLESDF_BOTTLE_DATA_ASSET, BUNDLESDF_NAPKIN_SYSTEM: BUNDLESDF_NAPKIN_DATA_ASSET, BUNDLESDF_PRISM_SYSTEM: BUNDLESDF_PRISM_DATA_ASSET}
