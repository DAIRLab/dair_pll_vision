...
SYSTEMS = [BUNDLESDF_CUBE_SYSTEM, CUBE_SYSTEM, ELBOW_SYSTEM, ASYMMETRIC_SYSTEM, BUNDLESDF_BOTTLE_SYSTEM, BUNDLESDF_NAPKIN_SYSTEM, BUNDLESDF_PRISM_SYSTEM, BUNDLESDF_TOBLERONE_SYSTEM]
...
BUNDLESDF_PRISM_DATA_ASSET = 'bundlesdf_prism'
BUNDLESDF_TOBLERONE_DATA_ASSET = 'bundlesdf_toblerone'
...
BUNDLESDF_PRISM_MESH_ASSET = 'bundlesdf_prism_mesh.urdf'
BUNDLESDF_TOBLERONE_MESH_ASSET = 'bundlesdf_toblerone_mesh.urdf'
REAL_DATA_ASSETS = {CUBE_SYSTEM: CUBE_DATA_ASSET, ELBOW_SYSTEM: ELBOW_DATA_ASSET, BUNDLESDF_CUBE_SYSTEM: BUNDLESDF_CUBE_DATA_ASSET, BUNDLESDF_BOTTLE_SYSTEM: BUNDLESDF_BOTTLE_DATA_ASSET, BUNDLESDF_NAPKIN_SYSTEM: BUNDLESDF_NAPKIN_DATA_ASSET, BUNDLESDF_PRISM_SYSTEM: BUNDLESDF_PRISM_DATA_ASSET, BUNDLESDF_TOBLERONE_SYSTEM: BUNDLESDF_TOBLERONE_DATA_ASSET}
...
BUNDLESDF_PRISM_URDFS = {MESH_TYPE: BUNDLESDF_PRISM_MESH_ASSET, POLYGON_TYPE: BUNDLESDF_PRISM_MESH_ASSET}
BUNDLESDF_TOBLERONE_URDFS = {MESH_TYPE: BUNDLESDF_TOBLERONE_MESH_ASSET, POLYGON_TYPE: BUNDLESDF_TOBLERONE_MESH_ASSET}
...
TRUE_URDFS = {CUBE_SYSTEM: CUBE_URDFS, ELBOW_SYSTEM: ELBOW_URDFS,
              ...
              BUNDLESDF_NAPKIN_SYSTEM: BUNDLESDF_NAPKIN_URDFS, BUNDLESDF_PRISM_SYSTEM: BUNDLESDF_PRISM_URDFS, BUNDLESDF_TOBLERONE_SYSTEM: BUNDLESDF_TOBLERONE_URDFS}
...
BUNDLESDF_PRISM_LR = 1e-3
BUNDLESDF_TOBLERONE_LR = 1e-3
LRS = {CUBE_SYSTEM: CUBE_LR, 
       ...
       BUNDLESDF_PRISM_SYSTEM: BUNDLESDF_PRISM_LR,
       BUNDLESDF_TOBLERONE_SYSTEM: BUNDLESDF_TOBLERONE_LR}
CUBE_WD = 0.0
ELBOW_WD = 0.0  #1e-4
ASYMMETRIC_WD = 0.0
...
BUNDLESDF_PRISM_WD = 0.0
BUNDLESDF_TOBLERONE_WD = 0.0
WDS = {CUBE_SYSTEM: CUBE_WD, 
       ...
       BUNDLESDF_PRISM_SYSTEM: BUNDLESDF_PRISM_WD,
