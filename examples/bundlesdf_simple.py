...
SYSTEMS = [BUNDLESDF_CUBE_SYSTEM, CUBE_SYSTEM, ELBOW_SYSTEM, ASYMMETRIC_SYSTEM, BOTTLE_SYSTEM]
...
# File management.
BUNDLESDF_DATA_ASSET = 'bundlesdf'
...
REAL_DATA_ASSETS = {CUBE_SYSTEM: CUBE_DATA_ASSET, ELBOW_SYSTEM: ELBOW_DATA_ASSET, BUNDLESDF_CUBE_SYSTEM: BUNDLESDF_DATA_ASSET, BOTTLE_SYSTEM: BUNDLESDF_DATA_ASSET}
...
TRUE_URDFS = {CUBE_SYSTEM: CUBE_URDFS, ELBOW_SYSTEM: ELBOW_URDFS,
              ASYMMETRIC_SYSTEM: ASYMMETRIC_URDFS, BUNDLESDF_CUBE_SYSTEM: BUNDLESDF_CUBE_URDFS, BOTTLE_SYSTEM: BUNDLESDF_BOTTLE_URDFS}
...
WDS = {CUBE_SYSTEM: CUBE_WD, ELBOW_SYSTEM: ELBOW_WD,
       ASYMMETRIC_SYSTEM: ASYMMETRIC_WD, BUNDLESDF_CUBE_SYSTEM: BUNLESDF_CUBE_WD}
